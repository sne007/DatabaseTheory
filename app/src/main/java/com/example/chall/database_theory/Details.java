...
import com.example.chall.database_theory.utils.Tools;
import com.example.chall.database_theory.utils.ViewAnimation;
...
public class Details extends AppCompatActivity {
    ...
    private Button hideClosure, hideMinimal,hideKeys, hideCheck3Nf, hideCheckBcnf, hideDecompBcnf, hideDecomp3Nf;
    ...
    private void initComponent() {
        ...
        // text section
        togleClosure = (ImageButton) findViewById(R.id.bt_toggle_text_closure);
        hideClosure = (Button) findViewById(R.id.bt_hide_text_closure);
        lytClosure = (View) findViewById(R.id.lyt_expand_text_closure);
        ...
        togleKeys = (ImageButton) findViewById(R.id.bt_toggle_text_keys);
        hideKeys = (Button) findViewById(R.id.bt_hide_text_keys);
        lytKeys = (View) findViewById(R.id.lyt_expand_text_keys);
